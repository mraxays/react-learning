...
function SideBar() {
  ...
  return (
    <aside className="w-1/4 bg-neutral-50 border-r border-neutral-200 px-6 py-8 hidden md:block">
      <div className="space-y-3 mb-4">
        <Link to="/create" className="w-full block text-center border border-neutral-300 text-neutral-700 py-3 rounded-full text-xs tracking-widest uppercase hover:bg-neutral-100 transition">
          Add Product
        </Link>
      </div>
