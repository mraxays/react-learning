      ...
      <div className="max-w-6xl mx-auto px-6 py-14 grid grid-cols-1 lg:grid-cols-2 gap-16">
        ...
        <div className="flex flex-col justify-between">
          ...
          <div className="space-y-4 pt-10">
            <button className="w-full bg-neutral-900 text-white py-4 rounded-full text-sm tracking-wide hover:bg-neutral-800 transition">
              Add to Bag
            </button>
            <button className="w-full border border-neutral-900 text-neutral-900 py-4 rounded-full text-sm tracking-wide hover:bg-neutral-200 transition">
              Buy Now
            </button>
